...
export default function Banner() {
  return (
    <div className="max-w-6xl mx-auto my-10 px-4">
      ...
      >
        {/* Slide 1 - Add Product */}
        <div className="relative h-80 md:h-96 bg-linear-to-r from-purple-500 via-pink-400 to-pink-300 flex flex-col justify-center items-start p-6 md:p-12">
        ...
        {/* Slide 2 - About */}
        <div className="relative h-80 md:h-96 bg-linear-to-r from-teal-400 via-sky-400 to-blue-500 flex flex-col justify-center items-start p-6 md:p-12">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">
            About Us
          </h2>
          <p className="text-white text-lg md:text-2xl mb-6">
        ...
        {/* Slide 3 - Contact */}
        <div className="relative h-80 md:h-96 bg-linear-to-r from-green-500 to-teal-400 flex flex-col justify-center items-start p-6 md:p-12">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">
            Contact Us
          </h2>
          <p className="text-white text-lg md:text-2xl mb-6">
